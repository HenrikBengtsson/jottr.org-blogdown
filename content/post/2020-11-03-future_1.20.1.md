...
First out is 'multicore' futures, which now join 'sequential', 'multisession', and both local and remote 'cluster' futures in the ability of relaying progress updates of **[progressr]** in a near-live fashion.  This means that all of our most common types of parallelization support near-live progress updates.  If this is the first time you hear of **progressr**, here's an example of how it can be used in parallel processing:
